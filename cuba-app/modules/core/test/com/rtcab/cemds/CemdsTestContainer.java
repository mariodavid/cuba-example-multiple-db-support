...
public class CemdsTestContainer extends TestContainer {

    public CemdsTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/rtcab/cemds/app.properties",
    ...
    public static class Common extends CemdsTestContainer {

        public static final CemdsTestContainer.Common INSTANCE = new CemdsTestContainer.Common();
